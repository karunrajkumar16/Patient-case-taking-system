...
export default function KioskHeader({
  ...
  return (
    <header className="w-full bg-white select-none shadow-sm shrink-0">
      ...
      <div className="max-w-7xl mx-auto px-4 py-1.5 flex justify-between items-center gap-2">
        {/* Left: Government of India Emblem & Ministry */}
        <div className="flex items-center space-x-2">
          <svg className="w-8 h-8 text-[#0F2942] shrink-0" viewBox="0 0 100 100" fill="currentColor">
          ...
          <div className="text-left leading-tight hidden sm:block">
            <div className="text-[11px] font-bold text-[#0F2942] uppercase tracking-wide">
              {language === 'hi' ? 'अध्यक्षभावन भारत' : 'Government of India'}
            </div>
            <div className="text-[10px] font-semibold text-gray-600 truncate">
              {language === 'hi'
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="text-center">
            <h1 className="text-2xl sm:text-3xl font-extrabold text-[#0F2942] tracking-tight leading-none">
              MediKiosk
            </h1>
        ...
        {/* Right: ABDM Logo & Quick Controls */}
        <div className="flex items-center space-x-3">
          <div className="flex items-center space-x-1.5">
            <div className="w-8 h-8 rounded-full border border-[#0056B3] bg-gradient-to-br from-blue-50 to-emerald-50 flex items-center justify-center p-0.5 shadow-xs">
          ...
          <div className="flex items-center space-x-1 text-xs">
            ...
            <Link
              href="/dashboard"
              className="text-[10px] text-gray-500 hover:text-red-700 font-semibold underline ml-1 hidden sm:inline"
            >
              Exit Kiosk
            </Link>
          </div>
