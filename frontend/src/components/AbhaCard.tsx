  ...
  return (
    <div className="w-full max-w-xl mx-auto select-none font-sans">
      ...
      <div className="bg-white rounded-xl border border-gray-300 shadow-md overflow-hidden relative">
        ...
        <div className="bg-[#1D3B8B] text-white px-3 py-2 flex items-center justify-between">
          
          {/* Left: National Health Authority Emblem & Logo Text */}
          <div className="flex items-center space-x-2">
            <svg className="w-7 h-7 text-white shrink-0" viewBox="0 0 100 100" fill="currentColor">
            ...
            <div className="leading-tight text-left">
              <div className="text-[10px] font-bold tracking-tight text-slate-100 leading-none">
                national
              </div>
              <div className="text-xs font-extrabold tracking-tight text-white leading-none mt-0.5">
                health
              </div>
              <div className="text-[10px] font-bold tracking-tight text-slate-100 leading-none">
                authority
          ...
          <div className="text-center leading-tight">
            ...
            <div className="text-[11px] font-bold tracking-wide text-slate-100">
              आयुष्मान भारत स्वास्थ्य खाता (आभा)
            </div>
          </div>

          {/* Right: Circular NHA Emblem Badge */}
          <div className="w-9 h-9 rounded-full bg-white p-0.5 shadow shrink-0 flex items-center justify-center">
        ...
        <div className="p-3.5 sm:p-4 bg-white relative">
          
          <div className="flex flex-col sm:flex-row items-center sm:items-start gap-4">
            
            {/* Left Column: Photo */}
            <div className="shrink-0">
              <div className="w-24 h-28 rounded-lg bg-slate-200 border border-gray-400 overflow-hidden shadow-xs flex items-end justify-center bg-gradient-to-b from-slate-100 to-slate-300">
                <svg className="w-20 h-22 text-[#1D3B8B]" viewBox="0 0 24 24" fill="currentColor">
            ...
            <div className="flex-1 text-left space-y-2 w-full">
              ...
              <div>
                ...
                <div className="text-base sm:text-lg font-bold text-gray-900 tracking-wide leading-none mt-0.5">
                  {patient.name}
                </div>
              </div>
              ...
              <div>
                ...
                <div className="text-base sm:text-lg font-bold font-mono text-gray-900 tracking-wider leading-none mt-0.5">
                  {abhaFormatted}
                </div>
              </div>
              ...
              <div>
                ...
                <div className="text-xs font-semibold font-mono text-gray-900 leading-none mt-0.5">
                  {abhaAddress}
                </div>
              </div>

              {/* Bottom Metadata 3 Columns */}
              <div className="grid grid-cols-3 gap-1.5 pt-1.5 border-t border-gray-200 text-[11px]">
                <div>
                  <div className="font-semibold text-gray-500">Gender / लिंग</div>
                  <div className="font-bold text-gray-900">{patient.gender}</div>
                </div>

                <div>
                  <div className="font-semibold text-gray-500">DOB / जन्मतिथि</div>
                  <div className="font-bold text-gray-900">{dobFormatted}</div>
                </div>

                <div>
                  <div className="font-semibold text-gray-500">Mobile / मोबाइल</div>
                  <div className="font-bold text-gray-900">{mobileFormatted}</div>
                </div>
              </div>
            ...
            <div className="shrink-0 flex flex-col items-center justify-center p-1.5 bg-white rounded-lg border border-gray-300 shadow-2xs self-center sm:self-start">
              <svg className="w-24 h-24 sm:w-26 sm:h-26" viewBox="0 0 100 100" fill="#1D3B8B">
      ...
      {showProceedButton && onProceed && (
        <div className="mt-4 flex justify-center">
          <button
            onClick={onProceed}
            className="bg-[#0056B3] hover:bg-[#004080] text-white font-extrabold text-lg px-8 py-3 rounded-xl shadow-md transition-all flex items-center gap-2"
          >
